...
cartpole_muzero_config = dict(
    exp_name=f'data_muzero/cartpole_muzero_ns50_upc{update_per_collect}_rer{reanalyze_ratio}_seed999',
    env=dict(
        env_id='CartPole-v1',
        stop_value=2000,#200,
        continuous=False,
...
if __name__ == "__main__":
    ...
    for seed in seeds:
        main_config.exp_name = f'data_muzero/cartpole_muzero_ns{num_simulations}_upc{update_per_collect}_rer{reanalyze_ratio}_seed{seed}'
        from lzero.entry import train_muzero
